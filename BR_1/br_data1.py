...
#Our Modules
from model_loader import br_dnn1
...
for lr in list_lr:
    ...
    for (n_idx, n) in enumerate(Ntrains):
        ...
        for label_idx in range(s):
            ...
            Yv = torch.tensor(np.float64(np.load(val_binlabel_file)))[:nval,label_idx]
            ...
            for e in range(epochs):
                ...
                if e % 9 == 0 and n_idx==len(Ntrains)-1:
                    ...
                    torch.save(
                        net.state_dict(),'./Clean_Data1Models/lr_'+str(lr)+
                        '/tag_'+str(label_idx)+
                        '/br-{}-{}-{}-{}-{}-{:.4f}.pt'.format(
                           label_idx, 
                           n ,e+1,batchsize,lr,
        ...
        #save the metrics
        np.save("./../Datasets/Data1/Clean_Metrics/br_lr_"+str(lr)+
                    "_metrics_data1.npy", np.array(br_metrics))
        dictionary={'br': br_metrics}
        savemat("./../Datasets/Data1/Clean_Metrics/br_lr_"+str(lr)+
            "_metrics_data1.mat", dictionary)
        #################### Save Excel File ##################
        ...
        df.to_excel("./../Datasets/Data1/Clean_Metrics/br_lr_"+str(lr)+
    ...
    # np.save("./../Datasets/Data1/Metrics/br_metrics_"+ymdstr+".npy",np.array(br_fbetaacc))
