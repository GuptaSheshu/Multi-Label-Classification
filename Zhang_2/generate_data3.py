...
print("======Generate probability-simplex on alphabet of size 2^s======")
...
print("===========Saving Train, Validation, and Test Files===========")
#Save Train Files
np.save("./../Datasets/Data3/Xtrain_"+timestr+".npy",X[0:ntrain,:])
np.save("./../Datasets/Data3/Ytrain_"+timestr+".npy",Y[0:ntrain])
np.save("./../Datasets/Data3/Ytrainbin_"+timestr+".npy",Ybin[0:ntrain,:])
np.save("./../Datasets/Data3/Ptrain_"+timestr+".npy",P[0:ntrain,:])
#Save Validation Files
np.save("./../Datasets/Data3/Xval_"+timestr+".npy",X[ntrain:ntrain+nval,:])
np.save("./../Datasets/Data3/Yval_"+timestr+".npy",Y[ntrain:ntrain+nval])
np.save("./../Datasets/Data3/Yvalbin_"+timestr+".npy",Ybin[ntrain:ntrain+nval,:])
np.save("./../Datasets/Data3/Pval_"+timestr+".npy",P[ntrain:ntrain+nval,:])
#Save Test Files
np.save("./../Datasets/Data3/Xtest_"+timestr+".npy",X[ntrain+nval:n,:])
np.save("./../Datasets/Data3/Ytest_"+timestr+".npy",Y[ntrain+nval:n])
np.save("./../Datasets/Data3/Ytestbin_"+timestr+".npy",Ybin[ntrain+nval:n,:])
np.save("./../Datasets/Data3/Ptest_"+timestr+".npy",P[ntrain+nval:n,:])

#compute bayes optimal classifier's Fbeta accuracy
print("===========Bayes-optimal accuracy calculation===========")
Fbeta=np.zeros((2**s,2**s))
for yhat in tqdm(range(2**s)): #yhats are along the rows
    for yt in tqdm(range(2**s)): #ys are along the columns
        if yhat==0 and yt==0:
            Fbeta[yhat][yt]=1
        else:
...
Ptest = np.load("./../Datasets/Data3/Ptest_"+timestr+".npy")
...
bayes_acc=0
# Ytest = np.load("Data3/Ytest_"+timestr+".npy")
Ytestbin = np.load("./../Datasets/Data3/Ytestbin_"+timestr+".npy")
...
print(bayes_acc)
np.save("./../Datasets/Data3/bayes_fbetaacc_data3_"+timestr+".npy",np.array([bayes_acc]))
