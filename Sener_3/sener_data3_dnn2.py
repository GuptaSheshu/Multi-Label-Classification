...
from model_loader3_dnn2 import get_model
...
#    	                grads[t][gr_i] = grads[t][gr_i] / gn[t]
            ...
            if epoch % 9 == 0 and n_idx==len(Ntrains)-1:
                ...
                torch.save(
                    state,'./Data3Models/lr_'+str(lrr)+'/sener_dnn2-{}-{}-{}-{}-{:.4f}.pt'.format(
        ...
        np.save("./../Datasets/Data3/Metrics/Sener_"+dnn_model+"_lr_"+str(lrr)+
                "_metrics_data3_.npy",np.array(sener_metrics))
    ...
    df.to_excel("./../Datasets/Data3/Metrics/Sener_"+dnn_model+"_lr_"+str(lrr)+
            "_metrics_data3_.xlsx" ,index=False)
