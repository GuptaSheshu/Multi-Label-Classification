...
for lr in list_lr:
    ...
    for (n_idx, n) in enumerate(Ntrains):    
        ...
        #        print('Half the learning rate{}'.format(n_iter))
            ...
            if epoch % 9 == 0 and n_idx==len(Ntrains)-1:
                ...
                torch.save(
                    state,'./Clean_Data1Models/lr_'+str(lr)+'/sener-{}-{}-{}-{}-{:.4f}.pt'.format(
        ...
        #save the metrics
        # np.save("./../Datasets/Data1/Clean_Metrics/sener_lr_"+str(lr)+
        #         "_metrics_data1.npy",np.array(sener_metrics))
        # dictionary={'sener': sener_metrics}
        # savemat("./../Datasets/Data1/Clean_Metrics/sener_lr_"+str(lr)+
        #     "_metrics_data1.mat",
        #     dictionary
        #     )
        ########################### Evaluation Metrics########################
    ...
    # df.to_excel("./../Datasets/Data1/Clean_Metrics/sener_lr_"+str(lr)+
