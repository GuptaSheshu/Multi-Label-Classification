...
from model_loader3_dnn3 import get_model
...
Ntrains=np.linspace(10,ntrain,50)
...
#    	                grads[t][gr_i] = grads[t][gr_i] / gn[t]
            ...
            if epoch % 9 == 0 and n_idx==len(Ntrains)-1:
                ...
                torch.save(
                    state,'./Data3Models/lr_'+str(lrr)+'/sener-{}-{}-{}-{}-{:.4f}.pt'.format(
        ...
        #save the metrics
        np.save("./../Datasets/Data3/Metrics/Sener_lr_"+str(lrr)+
                "_metrics_data3.npy",np.array(sener_metrics))
        ########################### Evaluation Metrics########################
    ##################################################
    ##################################################
    ##################################################
    ...
    df.to_excel("./../Datasets/Data3/Metrics/Sener_lr_"+str(lrr)+
