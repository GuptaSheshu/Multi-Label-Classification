...
% bayes_acc = load("./Datasets/Data3/Metrics/bayes_fbeta_cleandata3.mat").bayes_fbeta;
...
for i = 1:length(list_lr)
    lr = list_lr(i);
    br_acc(i,:,:) = load(['./Datasets/Data3/Metrics/br_lr_' num2str(lr)... 
                     '_metrics_data2.mat']).br;

    zhang_acc(i,:,:) = load(['./Datasets/Data3/Metrics/zhang_lr_' num2str(lr)... 
                     '_metrics_data2.mat']).zhang;
    for j =1:3
        sener_acc(j,i,:,:) = load(['./Datasets/Data3/Metrics/sener_dnn' num2str(j) '_lr_' num2str(lr)... 
...
%         st_s = ['Sener_' num2str(j) '_lr_' num2str(list_lr(i))];
    ...
    grid on
    hold on
    savefig(['./LearningCurves/Dataset3/dataset3_lr_' num2str(list_lr(i)) '.fig'])
%     set(gca,'xscale','log')
